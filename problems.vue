<template>
  <div class="wrapper">
    <!-- 标签 -->
    <div class="tag animated fadeInDown">
      <div>
        <input
          type="text"
          placeholder="算法语言"
          v-model.trim="search.algorithmTag"
          @keyup.enter="GetByConditions"
        />
      </div>
      <div>
        <input
      ...
      <i class="iconfont i-history" @click="getNowPro"></i>
    </div>
