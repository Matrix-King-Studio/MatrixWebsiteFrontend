<template>
  <div class="wrapper">
    <div class="left animated fadeInLeft">
      <div class="li" :class="i==index?'active':''" v-for="(item,index) in leftLi" @click="leftCli(item,index)">
        {{item.groupName}}
      </div>
    </div>
    <div class="right">
      ...
      <transition name="fade" enter-active-class="animated fadeInUp" leave-active-class="animated fadeOutDown">
        <div class="bottom" v-if="mod!=''" ref="bottom" :style="{justifyContent:'flex-start'}">
          <div v-for="(item,index) in mod" class="li">
            ...
            <div class="liBottom">
              ...
              <div class="buttonwrap">
                <div v-if="item.learnPointVOList!=''" >
                  <div v-for="(jtem,j) in item.learnPointVOList" @click="url(jtem)" :title="jtem.pointType+':'+jtem.pointName">
